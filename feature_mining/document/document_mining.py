...
class DocumentMining:
    def __init__(self, df_merge_train, df_pageviews):
        ...
        self.total_pageviews = df_pageviews.shape[0]
        self.total_click = None

    def get_total_click(self):
        # TODO Need to calculate total click
    ...
    def __get__click__number(self, __id, __field__name):
        return self.df_merge_train[(self.df_merge_train[__field__name] == id) & (self.df_merge_train[constant.CLICKED_COLUMN_NAME] == 1)].shape[0]
...
if __name__ == '__main__':
    ...
    doc_id = 1823412
    print(docMining.get_doc_id_feature())