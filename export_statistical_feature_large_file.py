...
if __name__ == '__main__':
    ...
    statisticFeatureGen = StatisticalFeatureLargeFileGenerator(
        ...
        merge_file_nrows=1000000,
        page_view_nrows=1000000,
        merge_data_chunk_size=1000000,
        page_view_chunk_size=1000000
    )
    ...
    for df in pd.read_csv(constant.get_test_merge_file(), header=0, chunksize=100, nrows=1000):
